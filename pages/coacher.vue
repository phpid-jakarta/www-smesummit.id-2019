  ...
  <div class="container">
    <section
      ...
      <div
        ...
        <span>More information about coacher, you can contact our PIC</span>
        <br>
...
export default {
  ...
  data () {
    return {
      url_api: `${API_ENDPOINT.REGISTER_COACHER}`,
      formData: {
        name: '',
        company_name: '',
        position: '',
  ...
  methods: {
    ...
    doSubmit () {
      if (this.checkFormValidation()) {
        ...
        this.$store.dispatch('postRegisterCoacher', {
          token: this._token,
          data: dataForSubmit,
