  ...
  <div class="container">
    <section
      ...
      <h2 class="title has-text-centered title-section caption-text">
        ON THE SPOT REGISTER FOR ATTENDANTS
      </h2>
      <form class="form">
        <!-- TOKEN -start -->
        <input
...
export default {
  name: 'RegisterOnTheSpot',
  layout: 'no-hero',
  head () {
    return {
      title: 'On The Spot Register for Participants | SME Summit 2019'
    }
  },
  mixins: [
    PageMixin
  ...
  methods: {
    ...
    doSubmit () {
      ...
      if (this.checkFormValidation()) {
        ...
        this.$store.dispatch('postOtsRegister', {
          token: this._token,
          data: dataForSubmit,
